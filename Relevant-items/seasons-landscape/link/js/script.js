...
class Transition {
  ...
  createTimeline() {
    ...
    staggerFromTo(this.dom.slices, 0.4, {
      xPercent: 100 },
    {
      xPercent: 0,
      ease: Expo.easeInOut },
    ...
    staggerFromTo(this.dom.lines, 0.5, {
      scaleX: 0 },
    {
      scaleX: 1,
      ease: Expo.easeInOut },
    ...
    fromTo(this.dom.lines[0], 0.5, {
      scaleX: 1 },
    {
      scaleX: 0,
      ease: Expo.easeInOut }).

    fromTo(this.dom.logo,0.5, {
      yPercent: 0 },
    {
      yPercent: 105,
      ease: Expo.easeOut },
    "-=1").
    staggerFromTo(this.dom.slices, 0.5, {
      xPercent: 0 },
    {
      xPercent: 100,
      ease: Expo.easeInOut },
    ...
    staggerFromTo(this.dom.titles, 1.8, {
      yPercent: 100 },
    {
      yPercent: 0,
      ease: Expo.easeInOut },
    0.05, 'imagesStart').
    staggerFromTo(this.dom.images, 1.5, {
      xPercent: -100 },
    {
      xPercent: 0,
      ease: Expo.easeInOut },
    0.05, 'imagesStart').
    staggerFromTo(this.dom.imagesInner, 1.5, {
      xPercent: 100 },
    {
      xPercent: 0,
      ease: Expo.easeInOut },
